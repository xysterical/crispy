...
from app.data.models import GmMemory, Product
        ...
        if creative_key and has_performance:
            feedback_rows.append(
                FeedbackRow(
                    ...
                    platform=_first(row, "platform") or "offline_csv",
        ...
        db.add(
            GmMemory(
                ...
                content={
                    ...
                    "summary": f"Offline CSV product {product_code}: ${revenue:.2f} simulated revenue, {quantity} units.",
                    "winning_patterns": [],
                    "avoid_patterns": [],
                    "evidence": [{"source": "offline_csv_import", "file_name": file_name}],
    ...
    db.add(
        GmMemory(
            ...
            content={
                ...
                "synced_at": _utcnow().isoformat(),
                "summary": f"Offline CSV store: ${total_revenue:.2f} simulated revenue across {len(product_metrics)} products.",
                "winning_patterns": [],
                "avoid_patterns": [],
                "evidence": [{"source": "offline_csv_import", "file_name": file_name, "product_count": len(product_metrics)}],
